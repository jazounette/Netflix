...
namespace ApiNetflix.Tools
{
    public class LoginService : ILogin
    {
        ...
        {
            User user = _data.Users.SingleOrDefault(x => x.Email == mail && x.Pass == password);
            ...
            descriptor.Audience = "http://localhost:5000/";
            ...
            descriptor.Subject = new ClaimsIdentity(new Claim[]
            {
                ...
                new Claim(ClaimTypes.Role,  false == _data.Admins.Any(e => e.UserId == user.Id)? "admin" : "user"),
            });
