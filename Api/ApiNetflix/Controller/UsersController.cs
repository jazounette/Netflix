...
namespace ApiNetflix.Controller
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(DataDbContext context, ILogin loginService)
        {
            _context = context;
        ...
        {
            string token = _loginService.LogIn(user.Email, user.Pass);
            if (token == null)
                ...
                return Ok(new { error = false, user.Nom, Token = token });
        }
        // GET: api/Users
        [HttpGet]
